...
const ALL_PRODUCTS = {
    ...
    cooking: {
        ...
        items: [
            { name: "Food Ingredients", img: `${BASE}Spices & Cooking Essentials/cooking-essentials-1.jpg` },
            { name: "Masala & Spice Powders", img: `${BASE}Spices & Cooking Essentials/cooking-essentials-2.jpg` },
            { name: "Fries and Pickles", img: `${BASE}Spices & Cooking Essentials/cooking-essentials-3.jpg` },
        ],
    ...
    shoes: {
        ...
        items: [
            ...
            { name: "White Shoes", img: `${BASE}School Shoes/shoes-3.jpg` },
        ],
    ...
    gifts: {
        ...
        items: [
            { name: "Decorative Gifts", img: `${BASE}Gift Items & Decor/gifts-1.jpg` },
            { name: "Mini Gift Sets", img: `${BASE}Gift Items & Decor/gifts-2.jpg` },
            { name: "Showpieces", img: `${BASE}Gift Items & Decor/gifts-3.jpg` },
            { name: "Wall Clock Collections", img: `${BASE}Gift Items & Decor/gifts-4.jpg` },
            { name: "Birthday Candles", img: `${BASE}Gift Items & Decor/decors-1.jpg` },
            { name: "Party Decorations", img: `${BASE}Gift Items & Decor/decors-2.jpg` },
            { name: "Decorative Wall Art", img: `${BASE}Gift Items & Decor/decors-3.jpg` },
        ],
